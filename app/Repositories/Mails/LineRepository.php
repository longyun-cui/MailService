...
class LineRepository {
    ...
    {
        $this->host = env('LINE_MAIL_HOST');
        $this->port = env('LINE_MAIL_PORT');
        $this->username = env('LINE_MAIL_USERNAME');
        $this->password = env('LINE_MAIL_PASSWORD');
    }
...
//        Mail::to('longyun-cui@163.com')->send(new OrderShipped());
        ...
        Mail::send('email.line.register.activation', $variate, function ($message) use ($post_data) {
