...
class KeronRepository {
    ...
    {
        $this->host = env('KERON_MAIL_HOST');
        $this->port = env('KERON_MAIL_PORT');
        $this->username = env('KERON_MAIL_USERNAME');
        $this->password = env('KERON_MAIL_PASSWORD');
    }
