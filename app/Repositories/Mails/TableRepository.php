...
class TableRepository {
    ...
    {
        $this->host = env('TABLE_MAIL_HOST');
        $this->port = env('TABLE_MAIL_PORT');
        $this->username = env('TABLE_MAIL_USERNAME');
        $this->password = env('TABLE_MAIL_PASSWORD');
    }
...
//        Mail::to('longyun-cui@163.com')->send(new OrderShipped());
        ...
        Mail::send('email.table.register.activation', $variate, function ($message) use ($post_data) {
